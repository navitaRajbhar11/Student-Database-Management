...
from .views import (
    CreateStudentView, StudentLoginView, AdminDeleteStudentView,
    AdminCreateAssignmentView, AdminListAssignmentView, AdminDeleteAssignmentView,
    StudentListAssignmentsView, StudentSubmitAssignmentView, AdminDeleteVideo,
    AdminCreateVideoLectureView, AdminListVideosLecturesView, AdminUpdateSubmissionView,
    StudentListVideosLecturesView, ListStudentsView, ListSubmissionsView, AdminDeleteSubmissionView,
    CreateScheduleView, ListSchedulesView, StudentScheduleView, AdminDeleteScheduleView, 
    AdminLoginView, AdminViewQueries, AdminDeleteQuery, StudentQueryView,StudentProfileView
